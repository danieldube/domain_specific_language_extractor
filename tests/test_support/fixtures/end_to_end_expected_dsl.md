...
| --- | --- | --- | --- | --- | --- |
| use | Action | int Use(const Widget &) | uses Widget | calls Add | int Add(int, int) | <root>/src/main.cpp:7:1-7:74<br>
<root>/src/main.cpp:7:15-7:21<br>
<root>/src/main.cpp:7:40-7:71 | Use | 3 |
| add | Action | int Add(int, int) | <root>/src/main.cpp:5:1-5:40<br>
<root>/src/main.cpp:7:40-7:71 | Add | 2 |
| widget | Entity | Widget | value | value: int | <root>/src/main.cpp:1:1-3:2<br>
<root>/src/main.cpp:2:3-2:12<br>
<root>/src/main.cpp:7:15-7:21 | Widget | 3 |
